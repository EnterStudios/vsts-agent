...
namespace Microsoft.VisualStudio.Services.Agent.Worker.Handlers
{
    ...
    public abstract class Handler : AgentService
    {
        ...
        protected void AddPrependPathToEnvironment()
        {
            ...
            string originalPath = ExecutionContext.Variables.Get("PATH") ?? System.Environment.GetEnvironmentVariable("PATH") ?? string.Empty;
            AddEnvironmentVariable("PATH", (prepend + Path.PathSeparator + originalPath).TrimEnd(Path.PathSeparator));
        }
    }
}